...
class AccountingController extends Controller
{
    ...
    private function canViewClientReport(): bool
    {
        $user = request()->user();
        ...
        /*
         * পুরোনো installation-এ permission
         * system না থাকলে backward compatibility।
         */
        return true;
    }

    private function authorizeClientReport(
        string $report
    ): void {
        if (
            $report === 'clients'
