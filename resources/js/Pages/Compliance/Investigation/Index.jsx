        ...
        <ComplianceLayout title="Public IP / Port Investigation">
            ...
            <form
                onSubmit={(event) => {
                    ...
                    router.get(route('compliance.investigation.index'), form, {
                        preserveState: true,
                        replace: true,
                    });
                }}
            ...
            >
                <div className="grid gap-4 md:grid-cols-5">
                    ...
                    <label>
                        <span className="mb-2 block text-sm font-bold">Protocol</span>
                        <select
                            value={form.protocol}
                    ...
                    <div className="flex items-end">
                        <button className="w-full rounded-xl bg-cyan-400 px-5 py-3 font-black text-slate-950">
                            Find Client
                        </button>
                    </div>
                </div>
...
function Info({ label, value }) {
    return (
        <div className="rounded-2xl bg-slate-900 p-4">
            ...
            <div className="mt-2 break-all font-bold">{value}</div>
        </div>
    );
}
